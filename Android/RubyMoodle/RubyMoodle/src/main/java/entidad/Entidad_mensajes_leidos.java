 ...
 */
public class Entidad_mensajes_leidos {
    ...
    public Entidad_mensajes_leidos(){

    }
    public Entidad_mensajes_leidos(Drawable foto, String useridfrom, String useridto, String subject, String fullmessage, String smallmessage, String fecha_creacion, long id){
        this.setFoto(foto);
    ...
    public Entidad_mensajes_leidos(Drawable foto, String useridfrom, String useridto, String subject, String fullmessage, String smallmessage, String fecha_creacion,String leido){
        this.setFoto(foto);
        this.setUseridfrom(useridfrom);
        this.setUseridto(useridto);
        this.setSubject(subject);
