 ...
 */
public class Entidad_enviar_mensaje
{
    ...
    public  Entidad_enviar_mensaje(){

    }

    public Entidad_enviar_mensaje(String user,String user_id_to,String user_id_from,String smallmessage,String fecha_creacion, String mensaje){
        super();
        this.setUser(user);
