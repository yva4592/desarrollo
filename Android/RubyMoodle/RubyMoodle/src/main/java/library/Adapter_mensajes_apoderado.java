...
public class Adapter_mensajes_apoderado extends BaseAdapter{

    protected Activity activity;
    protected ArrayList<Entidad_mensajes_apoderado> items;

    public Adapter_mensajes_apoderado(Activity activity, ArrayList<Entidad_mensajes_apoderado> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            v = inf.inflate(R.layout.item_mensajes_apoderado, null);
        }
        try{
        // Creamos un objeto mensajes
            Entidad_mensajes_apoderado em = items.get(position);
       ...
       //se corta la cadena desde el caracter 18 hasta el -1
        ...
        leido.setText(em.getFecha_creacion());

        // Retornamos la vista
        }
        catch (Exception e)
        {
                Log.e("Clase mensajes_apoderado", "error en el adapater",e);
