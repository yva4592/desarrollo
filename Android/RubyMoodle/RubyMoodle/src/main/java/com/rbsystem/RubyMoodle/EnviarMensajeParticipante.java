...
public class EnviarMensajeParticipante extends ActionBarActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_enviar_mensaje_participante);
        ...
        if (extras != null)
        {
            ...
            Log.e("Clase EnviarMensajeParticipantes","useridfrom"+enviar_mensaje.getUser_id_from());
            Log.e("Clase EnviarMensajeParticipantes","useridto"+enviar_mensaje.getUser_id_to());
            Log.e("Clase EnviarMensajeParticipantes","user: " + enviar_mensaje.getUser());
            Log.e("Clase EnviarMensajeParticipantes","token: " + token);
    ...
    public boolean loginstatus(String mensaje)
    {
        ...
        if (jdata!=null && jdata.length() > 0)
        {
            ...
            try
            {
                ...
                {
                    Intent i=new Intent(EnviarMensajeParticipante.this, MainActivity.class);
                    startActivity(i);
                    System.exit(0);
                }
                else
    ...
    class asynclogin extends AsyncTask< String, String, String >
    {
        protected void onPreExecute()
        {
            ...
            pDialog = new ProgressDialog(EnviarMensajeParticipante.this);
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (result.equals("ok"))
            {
                Toast toast1 = Toast.makeText(getApplicationContext(),"El mensaje fue enviado con éxito ", Toast.LENGTH_LONG);
                toast1.show();
