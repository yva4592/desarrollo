...
public class EnviarMensajeProfesor extends ActionBarActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_enviar_mensaje_profesor);
        ...
        if (extras != null)
        {
            ...
            Log.e("Clase EnviarMensajeProfesor","useridfrom"+enviar_mensaje.getUser_id_from());
            Log.e("Clase EnviarMensajeProfesor","useridto"+enviar_mensaje.getUser_id_to());
            Log.e("Clase EnviarMensajeProfesor","user: " + enviar_mensaje.getUser());
            Log.e("Clase EnviarMensajeProfesor","token: " + token);
    ...
    public boolean loginstatus(String mensaje)
    {
        ...
        if (jdata!=null && jdata.length() > 0)
        {
            ...
            try
            {
                ...
                {
                    Intent i=new Intent(EnviarMensajeProfesor.this, MainActivity.class);
                    startActivity(i);
                    System.exit(0);
                }else{
    ...
    class asynclogin extends AsyncTask< String, String, String >
    {
        protected void onPreExecute()
        {
            ...
            pDialog = new ProgressDialog(EnviarMensajeProfesor.this);
